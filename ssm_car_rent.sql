...
Source Database       : ssm_car_rent

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2020-02-04 16:06:28
*/
...
CREATE TABLE `t_car` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='车辆表';
...
INSERT INTO `t_jilu` VALUES ('21', '苏N3B951', '15', '16', '13', '12', '321321100011001101', '17830303333', 'test', '\\uploads\\2019-05-13\\32e28c29-c978-471a-ae90-f4508eb11086.jpg', '\\uploads\\2019-05-13\\810b110e-9d27-445f-9042-7075e66eb071.jpg', '2019-05-13 17:44:27', '2019-05-13 18:18:30', '16.00', '技术人员已确认', '1', '', '0');
...
CREATE TABLE `t_ri` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='日统计表';

-- ----------------------------
-- Records of t_ri
-- ----------------------------
INSERT INTO `t_ri` VALUES ('4', '2019-05-19 ', '15', '0');
INSERT INTO `t_ri` VALUES ('5', '2019-05-13 ', '64', '201');
INSERT INTO `t_ri` VALUES ('6', '2019-05-08 ', '146', '500');
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('1', 'admin', 'admin', '1', '系统管理员', null, null, null);
INSERT INTO `t_user` VALUES ('11', 'matou', '123456', '4', 'a', '17850505555', '2019-05-08 16:39:44', '312312199400000000');
INSERT INTO `t_user` VALUES ('12', 'jishu', '123456', '3', 'mbm', '17850501209', '2019-05-08 16:42:03', null);
INSERT INTO `t_user` VALUES ('13', 'gongzuo', '123456', '2', 'mr', '17845020202', '2019-05-08 16:42:30', null);
...
CREATE TABLE `t_yuding` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='预定表';

-- ----------------------------
-- Records of t_yuding
-- ----------------------------
INSERT INTO `t_yuding` VALUES ('6', 'a', '312312199400000000', '17850505555', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '11', '预定成功', '2019-05-08 17:41:05', '2019-05-08 17:41:40', '苏N3B944', '10', '13', '无');
INSERT INTO `t_yuding` VALUES ('7', 'a', '312312199400000000', '17850505555', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '11', '预定失败', '2019-05-08 17:45:35', '2019-05-08 17:48:27', '苏N3B942', '7', '13', '');
INSERT INTO `t_yuding` VALUES ('8', 'a', '312312199400000000', '17850505555', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '11', '预定成功', '2019-05-08 17:46:43', '2019-05-08 17:48:24', '苏N3B943', '9', '13', '无');
INSERT INTO `t_yuding` VALUES ('9', 'b', '31231199730222222', '17840401212', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '14', '预定成功', '2019-05-08 17:48:03', '2019-05-08 17:48:20', '苏N3B944', '10', '13', '无');
INSERT INTO `t_yuding` VALUES ('10', 'a', '312312199400000000', '17850505555', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '11', '预定成功', '2019-05-13 15:01:00', '2019-05-13 15:01:18', '苏N3B949', '17', '13', '无');
INSERT INTO `t_yuding` VALUES ('11', 'a', '312312199400000000', '17850505555', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '11', '预定成功', '2019-05-13 17:00:36', '2019-05-13 17:01:10', '苏N3B950', '16', '13', '无');
INSERT INTO `t_yuding` VALUES ('12', 'a', '312312199400000000', '17850505555', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '11', '预定成功', '2019-05-13 17:17:17', '2019-05-13 17:18:00', '苏N3B951', '15', '13', '无');
INSERT INTO `t_yuding` VALUES ('13', 'test', '321321100011001101', '17830303333', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '16', '预定成功', '2019-05-13 17:43:33', '2019-05-13 17:44:30', '苏N3B949', '17', '13', '');
INSERT INTO `t_yuding` VALUES ('14', 'test', '321321100011001101', '17830303333', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '16', '预定成功', '2019-05-13 17:43:58', '2019-05-13 17:44:27', '苏N3B951', '15', '13', '');
INSERT INTO `t_yuding` VALUES ('15', 'a', '312312199400000000', '17850505555', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '11', '预定成功', '2019-05-13 17:45:07', '2019-05-13 17:45:22', '苏N3B948', '14', '13', '');
INSERT INTO `t_yuding` VALUES ('16', 'a', '312312199400000000', '17850505555', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '11', '已取消', '2019-05-13 18:19:44', null, '苏N3B948', '14', '0', '');
INSERT INTO `t_yuding` VALUES ('17', 'a', '312312199400000000', '17850505555', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '\\uploads\\2019-05-08\\0b4ff66a-0b9d-4ab7-bf83-34a24bcc42c8.jpg', '11', '预定成功', '2019-05-13 18:21:01', '2019-05-13 18:21:18', '苏N3B946', '12', '13', '');
...
CREATE TABLE `t_yue` (
  ...
  `weihu` int(11) DEFAULT NULL COMMENT '维护费',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='月统计';

-- ----------------------------
-- Records of t_yue
-- ----------------------------
INSERT INTO `t_yue` VALUES ('30', '2019-05', '225', '701');
